...
<form action="updateEmp" method="get">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="id" name="eid" value="${param.eid}" >
  </div>
  <div class="form-group">
  ...
  <button type="submit" value="updateEmp" class="btn btn-primary" style="display: grid;margin: auto;">Submit</button>
</form>
</body>
</html>